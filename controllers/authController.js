...
const login = async (req, res) => {
  ...
  try {
    ...
    else if (normalizedRole.includes("warehouse")) redirectUrl = "/action-analytics";
    ...
    else if (normalizedRole === "superadmin") redirectUrl = "/admin/panel";
    return res.json({
      success: true,
...
const renderDashboard = (req, res) => {
  ...
  else if (normalizedRole.includes("warehouse")) return res.redirect("/action-analytics");
  else if (normalizedRole === "admin") return res.redirect("/job-creation");
  else if (normalizedRole === "dashboard") return res.redirect("/dashboard-admin");
  else if (normalizedRole === "rm") return res.redirect("/dashboard-admin");
  else if (normalizedRole === "superadmin") return res.redirect("/admin/panel");
